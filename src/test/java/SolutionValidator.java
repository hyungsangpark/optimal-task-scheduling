...
//        }
        ...
        for (int i = 0; i < numTasks; i++) {
            ...
            inputDurations[i] = (int)inputTask.getAttribute("Weight");
            outputDurations[i] = (int)outputTask.getAttribute("Weight");
            ...
            outputTask.leavingEdges().forEach(e -> {
                ...
                int commCost = (int)e.getAttribute("Weight");
...
//            }
        ...
        for (int i = 0; i < numTasks; i++) {
            if (!parentsCompleteBeforeTask(startTimes, inputDurations, commCosts, numTasks, scheduledOn,inputFileName)) {
    ...
    private boolean parentsCompleteBeforeTask(int[] startTimes, int[] durations, int[][] commCosts, int numTasks,
                                              int[] scheduledOn,String filename) {
